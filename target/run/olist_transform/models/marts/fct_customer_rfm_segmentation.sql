  ...
  create or replace   view OLIST_PROJECT.PUBLIC.fct_customer_rfm_segmentation
...
left join OLIST_PROJECT.PUBLIC.stg_order_items oi on o.order_id = oi.order_id
...
from OLIST_PROJECT.PUBLIC.stg_customers c
